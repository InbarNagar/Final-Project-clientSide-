...
const AppointmentCard_forClient = (props) => {
  const {Review_Number,Business_Number,ClientIDnumber,Number_appointment, AddressCity,AddressHouseNumber,AddressStreet,backgroundColor, Treatment_Type, Client_Name, Start_time, End_time, Date1, BusinessName } = props;
